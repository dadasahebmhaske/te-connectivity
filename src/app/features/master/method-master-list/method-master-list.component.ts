...
@Component({
  selector: 'app-method-master-list',
  templateUrl: './method-master-list.component.html',
  styleUrls: ['./method-master-list.component.css']
})
export class MethodMasterListComponent implements OnInit {
  custData:any;
  ...
  configureGrid(){
    ...
    , width: "48",
      ...
      // { name: 'MethodId', displayName: 'Method Id', width:"*", cellTooltip: true,filterCellFiltered: true},
       { name: 'Name', displayName: 'Method Name', width:"*", cellTooltip: true,filterCellFiltered: true},
